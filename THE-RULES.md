...
Agent reads AIRULES.md + CONTEXT.md before writing a single line of code. No confirmation = stop and ask for it.
...
End of every chat → V0 updates AIRULES.md + CONTEXT.md + PROMPT-LOG.md.
