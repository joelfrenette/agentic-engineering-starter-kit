# AIRULES.md - Agile99 Project Rules
...
"AIRULES.md OK | CONTEXT.md OK | Phase: [X] | Goal: [X]"
...
- Read Before You Write (AIRULES + CONTEXT confirmed first)
...
3. Propose new rules for AIRULES.md if anything broke
